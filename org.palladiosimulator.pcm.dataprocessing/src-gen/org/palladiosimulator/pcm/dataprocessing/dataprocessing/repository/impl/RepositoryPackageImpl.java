...
public class RepositoryPackageImpl extends EPackageImpl implements RepositoryPackage
{
	 ...
	 * @see org.palladiosimulator.pcm.dataprocessing.dataprocessing.repository.RepositoryPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	...
	public void createPackageContents()
	{
		...
		createEReference(storeContainerEClass, STORE_CONTAINER__STORES);
	...
	public void initializePackageContents()
	{
		...
		initEReference(getStoreContainer_Stores(), this.getStore(), this.getStore_Container(), "stores", null, 0, -1, StoreContainer.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
