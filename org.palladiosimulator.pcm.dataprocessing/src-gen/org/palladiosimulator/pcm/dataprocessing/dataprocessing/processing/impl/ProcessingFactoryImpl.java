...
public class ProcessingFactoryImpl extends EFactoryImpl implements ProcessingFactory
{
	...
	public EObject create(EClass eClass)
	{
		switch (eClass.getClassifierID())
		{
			...
			case ProcessingPackage.SYSTEM_DISCARD_DATA: return (EObject)createSystemDiscardData();
			...
			case ProcessingPackage.DELETE_DATA_OPERATION: return (EObject)createDeleteDataOperation();
			default:
	...
	{
		SystemDiscardDataImpl systemDiscardData = new SystemDiscardDataImpl();
		return systemDiscardData;
	}
	...
	{
		DeleteDataOperationImpl deleteDataOperation = new DeleteDataOperationImpl();
