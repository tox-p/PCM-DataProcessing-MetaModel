...
/**
 * This is the item provider adapter for a {@link org.palladiosimulator.pcm.dataprocessing.dataprocessing.repository.StoreContainer} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class StoreContainerItemProvider extends EntityItemProvider
{
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object)
	{
		if (childrenFeatures == null)
		{
			...
			childrenFeatures.add(RepositoryPackage.Literals.STORE_CONTAINER__STORES);
		}
	...
	/**
	 * This returns StoreContainer.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	{
		return overlayImage(object, getResourceLocator().getImage("full/obj16/StoreContainer"));
	}
	...
	{
		String label = ((StoreContainer)object).getId();
		return label == null || label.length() == 0 ?
			getString("_UI_StoreContainer_type") :
			getString("_UI_StoreContainer_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification)
	{
		...
		switch (notification.getFeatureID(StoreContainer.class))
		{
			case RepositoryPackage.STORE_CONTAINER__STORES:
