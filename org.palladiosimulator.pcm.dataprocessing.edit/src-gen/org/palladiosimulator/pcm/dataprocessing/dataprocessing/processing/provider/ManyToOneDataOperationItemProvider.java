...
/**
 * This is the item provider adapter for a {@link org.palladiosimulator.pcm.dataprocessing.dataprocessing.processing.ManyToOneDataOperation} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ManyToOneDataOperationItemProvider extends DataOperationItemProvider
{
	/**
	 ...
	 * @generated
	 */
	public ManyToOneDataOperationItemProvider(AdapterFactory adapterFactory)
	{
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ManyToOneDataOperation_consumedData_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ManyToOneDataOperation_consumedData_feature", "_UI_ManyToOneDataOperation_type"),
				 ProcessingPackage.Literals.MANY_TO_ONE_DATA_OPERATION__CONSUMED_DATA,
				 true,
				 false,
				 true,
				 null,
	...
	{
		String label = ((ManyToOneDataOperation)object).getId();
